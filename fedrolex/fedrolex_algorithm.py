...
class Algorithm(fedavg.Algorithm):
    ...
    def choose_rate_new(self, model_class, rate):
        self.model_class = model_class
        self.current_rate = rate
    def choose_rate_1(self, limitation, model_class):
        """
    ...
    def get_local_parameters(self):
        ...
        for key, value in self.model.state_dict().items():
            # print("当前是",key,"当前的维度是",value.shape)
        ...
        #         print("当前是",key,"当前的维度是",local_parameters[key].shape)
        # import time
        # time.sleep(6000)
